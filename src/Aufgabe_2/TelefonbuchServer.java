...
public class TelefonbuchServer extends Thread {
	...
	public TelefonbuchServer(Socket client,ServerSocket server) {
			...
			if (httpMethod.equals("GET")) {				
				...
				if (httpQueryString.equals("/")||httpQueryString.equals("/?")||httpQueryString.equals("/favicon.ico")) {
					...
					{	
						...
						//Sucht mit Hilfe des Telefonbuchs aus aufgabe 1 in leicht abgewandelter Form 
						...
						for (int i = 0; i < telefonbuch.ausgabeName.size();i++){
							responseString +="<tr>\n<th>"+telefonbuch.ausgabeName.get(i)+"</th>\n</tr>\n";
						}
						for (int i = 0; i < telefonbuch.ausgabeNummern.size();i++){
							responseString +="<tr>\n<th>"+telefonbuch.ausgabeNummern.get(i)+"</th>\n</tr>\n";
						}
	...
	public void sendResponse(int statusCode, String responseString,
		...
		responseString = TelefonbuchServer.HTML_START + responseString
				+ TelefonbuchServer.HTML_END;
	...
	public static void main(String args[])  {
		try {
			...
			while (true) {				
				...
				(new TelefonbuchServer(connected,server)).start();
			}
		} catch (Exception e) {			
		}
